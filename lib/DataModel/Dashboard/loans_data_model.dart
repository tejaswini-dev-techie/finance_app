class LoansDataModel {
  bool? status;
  bool? logout;
  String? message;
  Data? data;

  LoansDataModel({this.status, this.logout, this.message, this.data});

  LoansDataModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    logout = json['logout'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    noLoanTitle = json['no_loan_title'];
    noLoanSubtitle = json['no_loan_subtitle'];
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['no_loan_title'] = noLoanTitle;
    data['no_loan_subtitle'] = noLoanSubtitle;
